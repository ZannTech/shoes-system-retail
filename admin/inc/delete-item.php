...
if (isset($_POST['deleteItem']) && !isset($_POST['searchItem'])) {
    ...
    if (isset($_POST['ProductID'])) {
        ...
        if (empty($ProductID)) {
            array_push($response, "Please a PID");
        }
        else{ 
            $deli = $pos->deleteSupply($ProductID);
            if (!$deli['error']) {
                array_push($response, "Item deleted from database");
            }
            else{
                array_push($response, $deli['msg']);
            }
...
<div class="row">
    ...
    <div class="card-body">
         ...
         <form class="form-horizontal" action="" method="POST">
            <div class="card-body">
                <h4 class="card-title">Delete Your Item</h4>
                                    <div class="row">
         ...
         <form class="form-horizontal"  action="" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0 text-right">
                                        <button type="submit" name="deleteItem" class="btn btn-info waves-effect waves-light">Delete Item</button>
                                    </div>
                                </div>
                            </form>
                        <?php } } ?>
