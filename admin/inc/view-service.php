...
<div class="row">
    ...
    <div class="card-body">
         ...
         <form class="form-horizontal" method="POST" action="">
            <div class="card-body">
                <center><h4 class="card-title">CUSTOMER SERVICE RECORDS</h4></center>
                <br>
                <br>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="tel" class="form-control" id="phone" name="customerPhone" disabled="" value="<?php echo $supply['customer_phone']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="returndate" class="col-sm-3 text-right control-label col-form-label">Return Date</label>
                                                 <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="returndate" id="returndate" disabled="" value="<?php echo $formats->formatTimeStamp('D , M , d, Y',$supply['return_date']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
